...
export const CARRIER_REGISTRY: CarrierDefinition[] = [
  {
    ...
    carrierCode: 'MAEU',
    scacCode: 'MAEU',
    containerPrefixes: ['MSKU', 'MRKU', 'MRSU', 'MAEU', 'PONU', 'TCNU', 'TCKU'],
    blPrefixes: ['MAEU', 'MSKU', 'MRKU', 'SUDU'],
  ...
  },
  {
    ...
    carrierCode: 'CMDU',
    scacCode: 'CMDU',
    containerPrefixes: ['CMAU', 'CMCU', 'CGMU', 'ECMU', 'CXDU', 'TLLU', 'TGHU'],
    blPrefixes: ['CMAU', 'CMDU', 'APLU', 'ANNU'],
  ...
  },
  {
    ...
    carrierCode: 'ONEY',
    scacCode: 'ONEY',
    containerPrefixes: ['ONEU', 'KKFU', 'NYKU', 'MOFU', 'MOEU', 'MOAU', 'MOTU', 'TCLU', 'NYKE'],
    blPrefixes: ['ONEY', 'ONEU', 'NYKS', 'MOLU', 'KKLU'],
  ...
  },
  {
    ...
    carrierCode: 'EGLV',
    scacCode: 'EGLV',
    containerPrefixes: ['EISU', 'EGHU', 'EGSU', 'EMCU', 'EITU', 'HMCU'],
    blPrefixes: ['EGLV', 'EISU'],
  ...
  },
  {
    ...
    carrierCode: 'COSU',
    scacCode: 'COSU',
    containerPrefixes: ['CCLU', 'COSU', 'CBHU', 'CSNU', 'CSLU', 'CXRU', 'CRSU'],
    blPrefixes: ['COSU', 'CCLU', 'CBHU'],
  ...
  },
  {
    ...
    carrierCode: 'YMLU',
    scacCode: 'YMLU',
    containerPrefixes: ['YMLU', 'YMMU', 'YMJU'],
    blPrefixes: ['YMLU', 'YMJA', 'YMAA', 'YMBA'],
